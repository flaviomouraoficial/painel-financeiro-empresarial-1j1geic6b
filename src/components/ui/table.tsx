...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn('[&_tr:last-child]:border-0 [&_tr:nth-child(even)]:bg-secondary/50', className)}
    {...props}
  />
))
...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
        'border-b transition-colors duration-200 hover:bg-secondary data-[state=selected]:bg-secondary',
        className,
      )}
      {...props}
    />
